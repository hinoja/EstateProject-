                                    ...
                                    <form method="POST" class="row gap-3" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                            ...
                                            <div class="box-password">
                                                <input style="height: 2.5rem;" type="password" type="password"
                                                    name="password" tabindex="2" required
                                                    class="form-contact style-1 password-field" placeholder="Password">
                                        ...
                                        <button type="submit"
                                            class="tf-btn primary w-80 text-center">@lang('Log in')</button>
