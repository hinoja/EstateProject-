            ...
            <div class="layout-wrap">
                            ...
                            <div class="col-lg-12">         
                                <div class="inner-container d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="logo-box d-flex">
                                        <div class="logo"><a href="index.html"><img src="{{asset('assets/images/logo/logo.jpg')}}" alt="logo" width="98" height="44"></a></div>
                ...
                <div class="sidebar-menu-dashboard">
                    <ul class="box-menu-dashboard">
                        <li class="nav-menu-item active"><a class="nav-menu-link" href="{{route('maison')}}"><span class="icon icon-home"></span>Maisons</a></li>
                        <li class="nav-menu-item"><a class="nav-menu-link" href="{{route('terrain')}}"><span class="icon icon-list-dashes"></span>Terrains</a></li>
                        <li class="nav-menu-item"><a class="nav-menu-link" href="{{route('lotissement')}}"><span class="icon icon-list-dashes"></span>Lotissement</a></li>
                        <li class="nav-menu-item"><a class="nav-menu-link" href="{{route('engin')}}"><span class="icon icon-car"></span>Engins</a></li>
                        ...
                        <li class="nav-menu-item"><a class="nav-menu-link" href="{{route('utilisateur')}}"><span class="icon icon-profile"></span>Utilisateurs</a></li>

                        <li class="nav-menu-item"><a class="nav-menu-link" href="{{route('terrain')}}"><span class="icon icon-review"></span>Messages</a></li>

                        <li class="nav-menu-item"><a class="nav-menu-link" href="{{route('profile')}}"><span class="icon icon-profile"></span>Profile</a></li>

                        <li class="nav-menu-item"><a class="nav-menu-link" href="#"><span class="icon icon-sign-out"></span>Logout</a></li>
                    </ul>
                </div>
