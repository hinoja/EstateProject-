        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="contact-content">
                    ...
                    <p class="body-2 text-variant-1">N'hésitez pas à nous contacter par le biais de nos canaux en ligne pour obtenir des informations et bien plus encore.</p>
                    <form id="contactform" method="post" action="#" class="form-contact">
                        ...
                        <div class="box grid-2">
                            <fieldset>
                                ...
                                <input type="text" class="form-control style-1" placeholder="telephone" name="phone" id="phone" required>
                            </fieldset>
                            <fieldset>
                                <label for="subject">Objet:</label>
                                <input type="text" class="form-control style-1" placeholder="objet" name="subject" id="subject">
                            </fieldset>
                        </div>
                        <fieldset class="box">
            ...
            <div class="col-lg-4">
                <div class="contact-info">
                    ...
                    <ul>
                        <li class="box">
                            <div class="text-1 title">Adresse:</div>
                            <p class="p-16 text-variant-1">Akwa Nord, Douala
                              <br>Cameroun</p>
                        </li>
                        <li class="box">
                            <div class="text-1 title">Infomation:</div>
                            <p class="p-16 text-variant-1">+237699591992<br> welldonerealestate237@yahoo.com</p>
                        </li>
                        <li class="box">
                            <div class="text-1 title">Ouvert:</div>
                            <p class="p-16 text-variant-1">Lundi - Vendredi : 08:00 - 18:00 <br> Saturday : 10:00 - 15:00</p>
